...
Mitochondrial function was supressed across all major functional categories in a similar fashion with no significant differences among functional categories ($Q_{M}$ = `r MLMR_list_Measure[[1]]$QM`, $df$ = `r MLMR_list_Measure[[1]]$QMdf[1]` and `r MLMR_list_Measure[[1]]$QMdf[2]`, $p$ = `r MLMR_list_Measure[[1]]$QMp` [@fig-orchard_measure]a). Treatment with corticostrone supressed respiration and metabolic capacity the greatest (respiraton: $\mu$ = `r MLMR_list_Measure_noint[[1]]$b[4]`, 95% CI: `r MLMR_list_Measure_noint[[1]]$ci.lb[4]` to `r MLMR_list_Measure_noint[[1]]$ci.ub[4]`, $p$ = `r MLMR_list_Measure_noint[[1]]$pval[4]`; metabolic capacity: $\mu$ = `r MLMR_list_Measure_noint[[1]]$b[2]`, 95% CI: `r MLMR_list_Measure_noint[[1]]$ci.lb[2]` to `r MLMR_list_Measure_noint[[1]]$ci.ub[2]`, $p$ = `r MLMR_list_Measure_noint[[1]]$pval[2]`) and increasing oxidative damage ($\mu$ = `r MLMR_list_Measure_noint[[1]]$b[3]`, 95% CI: `r MLMR_list_Measure_noint[[1]]$ci.lb[3]` to `r MLMR_list_Measure_noint[[1]]$ci.ub[3]`, $p$ = `r MLMR_list_Measure_noint[[1]]$pval[3]`). 

While effects appeared to be stronger in mammals, there were no significant differences among classes ($Q_{T}$ = `r MLMR_list_taxa[[1]]$QM`, $df$ = `r MLMR_list_taxa[[1]]$QMdf[1]` and `r MLMR_list_taxa[[1]]$QMdf[2]`, $p$ = `r MLMR_list_taxa[[1]]$QMp`; [@fig-orchard_taxa]a). Overall, mitochondrial function was significantly supressed in mammals ($\mu$ = `r MLMR_list_taxa_noint[[1]]$b[3]`, 95% CI: `r MLMR_list_taxa_noint[[1]]$ci.lb[3]` to `r MLMR_list_taxa_noint[[1]]$ci.ub[3]`, $p$ = `r MLMR_list_taxa_noint[[1]]$pval[3]`) and fish ($\mu$ = `r MLMR_list_taxa_noint[[1]]$b[1]`, 95% CI: `r MLMR_list_taxa_noint[[1]]$ci.lb[1]` to `r MLMR_list_taxa_noint[[1]]$ci.ub[1]`, $p$ = `r MLMR_list_taxa_noint[[1]]$pval[1]`), but effects were weaker in birds ($\mu$ = `r MLMR_list_taxa_noint[[1]]$b[2]`, 95% CI: `r MLMR_list_taxa_noint[[1]]$ci.lb[2]` to `r MLMR_list_taxa_noint[[1]]$ci.ub[2]`, $p$ = `r MLMR_list_taxa_noint[[1]]$pval[2]`).
...
Social deprevation studies were only ever done with mammals, and all studies manipulated environments postnatally. Mitochondrial function was supressed across all major functional categories with no significant differences among functional categories ($Q_{M}$ = `r MLMR_list_Measure[[2]]$QM`, $df$ = `r MLMR_list_Measure[[2]]$QMdf[1]` and `r MLMR_list_Measure[[2]]$QMdf[2]`, $p$ = `r MLMR_list_Measure[[2]]$QMp`). Nonetheless, effects were more negative for antioxidant capacity () and oxidative damage () compared to metabolic capacity ([@fig-orchard_measure]b).
